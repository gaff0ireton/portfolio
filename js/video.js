...
//   setInterval("showClock()", 1);
    ...
    const btns_open = document.querySelectorAll('.worksSection__detailButton');
    const btns_close = document.querySelectorAll('.worksSection__closeButton');
    const modals = document.querySelectorAll('.worksSection__modal');
    ...
    btns_open.forEach((btn,index) =>{
        btn.addEventListener('click',function(){
            modals[index].showModal();
        })
    });

    btns_close.forEach((btn,index) =>{
        btn.addEventListener('click',function(){
            modals[index].close();
        })
    });